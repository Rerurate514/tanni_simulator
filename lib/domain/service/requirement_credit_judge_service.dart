...
class RequirementCreditJudgeService {
  ...
  //決められた必修科目単位を超えているか
  bool isProfessionalRequirementMet(Ref ref, RequirementModel selectedRequirement, int profCredits) {
  ...
  //決められた教養科目単位を超えているか
  bool isGeneralRequirementMet(Ref ref, RequirementModel selectedRequirement, int genCredits) {
    return switchByCategoriesLength<bool>(
      selectedRequirement,
      () => true,
      (category, type) {
